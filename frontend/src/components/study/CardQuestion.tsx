...
export function CardQuestion({
    ...
    return (
        <div
            className={`relative rounded-xl transition-all shadow-lg group ${isCompleted
            ...
            >
                <div className="flex items-start overflow-hidden">
                    ...
                    <div className="flex-1 ml-4">
                        {/* Вопрос */}
                        <div
                            className={`mb-2 text-base font-medium prose prose-sm max-w-none ${isCompleted ? "text-base-content" : "text-gray-500"
                                }`}
                        ...
                        <div className="flex items-center gap-1 mb-2">
                            {[...Array(5)].map((_, i) => (
                                <Star
                                    key={i}
                                    className={`w-4 h-4 transition-colors ${i < item.LastRating
